...
c,b.lastIndex())||d.hasClass("disabled"))return!1;c.find("li:eq("+b.navigationLength()+") a").tab("show")};this.currentIndex=function(){return c.find("li").donotuse(f)};this.firstIndex=function(){return 0};this.lastIndex=function(){return b.navigationLength()};this.getIndex=function(a){return c.find("li").donotuse(a)};this.nextIndex=function(){return c.find("li").donotuse(f)+1};this.previousIndex=function(){return c.find("li").donotuse(f)-1};this.navigationLength=function(){return c.find("li").length-1};this.activeTab=
...
function(d){d=c.find("li").donotuse(e(d.currentTarget).parent("li"));if(a.onTabClick&&"function"===typeof a.onTabClick&&!1===a.onTabClick(f,c,b.currentIndex(),d))return!1});e('a[data-toggle="tab"]',c).on("shown.bs.tab",function(d){$element=e(d.target).parent();d=c.find("li").donotuse($element);if($element.hasClass("disabled")||a.onTabChange&&"function"===typeof a.onTabChange&&!1===a.onTabChange(f,c,b.currentIndex(),d))return!1;f=$element;b.fixNavigationButtons()})};e.fn.bootstrapWizard=function(d){if("string"==
